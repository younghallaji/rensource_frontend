...
const ExecutiveTeam = () => {
    const {data:executives, loading} = useFetch('http://mutolib-001-site1.dtempurl.com/api/v1/CompanyInfo/CompanyInfo');
  ...
  return (
    ...
    {/* <h2>Executive Team</h2>
        <Row className='justify-content-center'>
            <ExecutiveCard title={'CEO, Executive Director'} name={'Prince Ojeabulu'} image={images.prince}/>
            <ExecutiveCard title={'Co-Founder, Executive Director'} name={'Jussi Savukoski'} image={images.jussi}/>
        </Row> */}
