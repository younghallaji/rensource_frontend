...
const SingleCaseStudy2 = () => {
    return (
        <>
            ...
            <SingleCaseHero topic={'Our Projects'} title={'Powering Valentine Chickens with a 120kWp Solar PV'}/>
                ...
                <Card className='col next-details col-md-6 col-sm-12'>
                    <div className="row">
                        <div className="col next-case-img col-sm-4 m-4">
                            <img src={images.poultry} alt="rensource-case-study" />
                        </div>
    
                        <div className="col col-sm-7 next-content">
                            <p style={{marginTop:'24px'}} className="solution-title">Powering Premium Poultry Farm with a 700kWp Solar PV</p>
